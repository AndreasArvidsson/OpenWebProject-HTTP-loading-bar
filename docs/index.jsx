...
var React = __webpack_require__(740);
...
var client = __webpack_require__(706);
// EXTERNAL MODULE: ./node_modules/lodash.clonedeep/index.js
var lodash_clonedeep = __webpack_require__(289);
var lodash_clonedeep_default = /*#__PURE__*/__webpack_require__.n(lodash_clonedeep);
;// ./node_modules/owp.http/lib/cache.js
const cache = {};
/* harmony default export */ const lib_cache = ({
  get: (key, callback) => {
    if (cache[key] == null) {
...
;// ./node_modules/owp.http/lib/xhr.js


let downloadjs;
function setDownloadjs(djs) {
  downloadjs = djs;
}
...
async function evaluateRequest(request) {
  ...
  let response;
  if (request.cache) {
    const res = await lib_cache.get(method + url, () => performRequest(url, method, !!queryString, request));
    //Make sure each hit of the cache resturns a unique copy.
    response = lodash_clonedeep_default()(res);
  } else {
...
async function doDownload(request, response) {
  if (!downloadjs) {
...
;// ./node_modules/owp.http/lib/HTTP.js
/**
...
class HTTP {
  ...
  constructor(urlOrHttp, ...args) {
    //Sub instance called internally by path().
    if (urlOrHttp instanceof HTTP) {
      this.options = lodash_clonedeep_default()(urlOrHttp.options);
  ...
  xhr(method, args) {
    const options = lodash_clonedeep_default()(this.options);
...
function staticXhr(method, url, args) {
...
function constructOptions(url, args) {
  const options = {
    url,
    params: {},
    headers: {}
...
function parseArguments(options, args) {
...
;// ./node_modules/owp.http/lib/index.js


// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(336);
;// ./index.jsx
/**
 * @author Andreas Arvidsson
...
/* harmony default export */ const index = (HTTPLoadingBar);
;// ./demo/test.js
console.log("test.js");
...
function doGet() {
  ...
  const url = "https://raw.githubusercontent.com/json-iterator/test-data/refs/heads/master/large-file.json?t=" + Date.now();
  lib_HTTP.get(url).then(() => {
    console.log("Done");
  }).catch(console.error);
}
const App = () => {
  const [className, setClassName] = (0,react.useState)();
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(index, {
      classNameInner: className
    }), /*#__PURE__*/(0,jsx_runtime.jsxs)("main", {
      className: "container",
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h1", {
        children: "owp.htttp-loading-bar"
